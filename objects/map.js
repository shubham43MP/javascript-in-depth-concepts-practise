 ...
 * Key field: in Object, it follows the rule of normal dictionary. The keys MUST be simple types —
 * either integer or string or symbols. Nothing more. But in Map it can be any data type (an object, an array, etc…).
 * (try using another object as Object’s property key — i dare you :))
